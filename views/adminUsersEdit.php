...
<div class="edit">
    <div class="container">
        <div class="edit-content">
            ...
            <?php if ($result): ?>
                <div class="register-done">Данные изменены.  <a href="/admin/users/<?php echo $id;?>" style="color: black">Вернуться назад</a> </div>
            <?php else: ?>
                    ...
                    <div class="edit-bio-group">
                        ...
                        <div class="edit-bio-row">
                            ...
                            <input type="text" placeholder="Фамилия" name="surname" id="surname"
                                   class="register-form-some" value="<?php echo $user->surname ?>">
                        </div>
                        <div class="edit-bio-row">
                            ...
                            <input type="text" placeholder="Отчество" name="patronymic" id="patronymic"
                                   class="register-form-some" value="<?php echo $user->patronymic ?>">
                        </div>
                        <div class="edit-bio-row">
                        ...
                        <div class="edit-bio-row">
                            ...
                            <input type="password" placeholder="E-mail" name="password" id="password" class="register-form-some"
