...
<div class="admin-toss">
    <div class="container">
        <div class="admin-toss-content">
            <div class="admin-toss-title">Жеребьевка турнира <?php echo $tournament->name;?></div>
            <div class="admin-toss-wrap">
                <?php if (!$result):?>
                    <form action="" method="post" class="invite-try-form">
                        <input type="submit" name="submit" value="Да,провести жеребьевку" class="register-form-button">
                        <div class="back"><a href="/admin/tournaments/<?php echo $tournament->id;?>">Нет, вернуться назад</a></div>
                    </form>
                <?php else:?>
                    <div class="invite-done">Жеребьевка проведена <a href="/admin/tournaments/<?php echo $id; ?>">Вы можете вернуться.</a></div>
                <?php endif; ?>
            </div>
